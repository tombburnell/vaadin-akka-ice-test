...
import console.ExampleComponents.ThemeSelector;
...
public class ConsoleDemo extends Application {
    ...
    public void init() {
        ...
        root.addComponent(new ThemeSelector());
...
//                setTheme("reindeer");
        ...
        menubar.addItem("Dash", null, new MenuBar.Command() {
            public void menuSelected(MenuBar.MenuItem selectedItem) {
//                setTheme("mytheme");
                changeView(getDashPanel());
            }
        });
    ...
    public DashPanel getDashPanel() {
        if (null == dashPanel) dashPanel = new DashPanel(pusher);
        return dashPanel;
    }
